...
function draw() {  
  ...
  fill("yellow");
  strokeWeight(2);
    text("Press down arrow key - Feeding, space- Running ",50,40);
    text("Press left arrow key - Playing, right arrow key- Sleeping ",20,70);
    text("Press up arrow key - Washroom ",100,100);
